            ...
            <div class="info-order">
                ...
                <table style="width:100%;margin-bottom:10px">
                    ...
                    <tr>
                            ...
                            <div class="item-info-left">
                                ...
                                <div>
                                    ...
                                    @if( $line_item->distributes_selected != null && count($line_item->distributes_selected) > 0 )
                                     <div class="distribute-product">{{$line_item->distributes_selected[0]->value }}
                        ...
                        <td style="float: right;"><div class="item-info-right price"> {{number_format($line_item->item_price)}}₫</div></td>
                    </tr>
                        ...
                        <td>
                            ...
                            width: 100%;">
                                <tbody>
                                    ...
                                    @endif
                                    @if( ($order->combo_discount_amount??0) > 0)
                                    <tr>
                                        <td style="padding: 5px 0">
                                    ...
                                    @endif
                                    @if( ($order->voucher_discount_amount??0) > 0)
                                    <tr>
                                        <td style="padding: 5px 0">
                                            <p style="color: gray;">	Giảm giá voucher</p>
                                        </td>
                                        <td style="padding: 5px 0;float:right">
                                            <strong>{{number_format($order->voucher_discount_amount)}}₫</strong>
                                        </td>
                                    </tr>
                                    @endif
                                    @if( ($order->balance_collaborator_used ??0)> 0)
                                    <tr>
                                        <td style="padding: 5px 0">
                                            <p style="color: gray;">	Sử dụng số dư CTV</p>
                                        </td>
                                        <td style="padding: 5px 0;float:right">
                                            <strong>{{number_format($order->balance_collaborator_used)}}₫</strong>
                                        </td>
                                    </tr>
                                    @endif
                                    @if( ($order->bonus_points_amount_used ??0)> 0)
                                    <tr>
                                        <td style="padding: 5px 0">
                                    ...
                                    @endif
                                    @if( ($order->total_shipping_fee ??0)> 0)
                                    <tr>
                                        <td style="padding: 5px 0">
