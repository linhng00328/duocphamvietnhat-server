...
class CreateSubElementDistributesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_element_distributes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sub_element_distributes');
    }
}
