...
class CreateAgencyEleDisPricesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('agency_ele_dis_prices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('agency_ele_dis_prices');
    }
}
