...
class CreateSaleCustomerConfigsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_customer_configs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sale_customer_configs');
    }
}
