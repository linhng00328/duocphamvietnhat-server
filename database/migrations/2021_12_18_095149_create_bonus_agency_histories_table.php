...
class CreateBonusAgencyHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bonus_agency_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bonus_agency_histories');
    }
}
